...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBoFgcX5w_JayvovRw4tAQwc3QySLIwwQ8&sensor=false" ></scr'+'ipt>');
...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			latitude: 	 10.17176039,
			longitude: 	 76.42690927,
			zoom: 			 16,
			type: 			 'ROADMAP',
			scrollwheel: false,
			marker: {
				...
				title: 			'GoodLook Modular Design',
				open: 			false,
				center: 		true
			},
			address: '<h2>Good Look</h2><p>Modular Design</p><p>Tel.: +30 210 123 4567<br />Fax: +30 210 123 4567</p>',
			styles: 'GRAYSCALE',
			locations: [
