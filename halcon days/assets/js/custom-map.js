var mapStyles = [
{
    ...
    {visibility:'on'}]},
        ...
        {visibility:'on'}
            ...
            featureType:'poi.medical',elementType:'all',
            stylers:[
            {hue:'#dddbd7'},
            {saturation:-80},
            {lightness:-2},
...
function createHomepageGoogleMap(_latitude,_longitude,_zoomvar){
    setMapHeight();
    if( document.getElementById('map') != null ){
        $.getScript("file.js", function(){
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                pictureLabel.setAttribute("id", "pic1");
                //var st = locations[i][7];
                var st = "6";
                document.getElementById("pic1").innerHTML = st;
                document.getElementById("pic1").style.height = "20px";
                //document.getElementById("pic1").innerHTML = "6";
                ...
                boxText.innerHTML =
                    '<div class="infobox-inner">' +
                        ...
                        '<div class="infobox-title"><a href="">' + locations[i][0] + '</a></div>' +
                        '<div class="infobox-title">' + locations[i][1] + '</div>' +
                        '</div>' +
                        '</div>';
                //Define the infobox
